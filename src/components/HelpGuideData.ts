...
export const HELP_SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    "content": "<h2>Recent Changes</h2>\n\n<!-- CHANGELOG_START -->\n<ul class=\"help-list\"><li>3b258ea: fix: remove invalid license property from package.json since electron-builder auto-detects build/license.txt</li>\n<li>b9e8950: chore: add legal documentation and update installer configs for EULA acceptance</li>\n<li>a23eee1: fix(document-editor): dynamic citation sequence numbering</li>\n<li>c22f435: Fix graph assembler preview placeholder issue</li>\n<li>a803372: fix: load citation CSL XML styles dynamically into active memory on document initiation to resolve template fallback bug</li>\n<li>5219714: fix: synchronize citation formatting engine initialization with stored document configuration on boot</li>\n<li>3abacce: feat: complete Research Desk module enhancements and fixes</li>\n<li>bdd3da0: fix(build): inject production license server URL into all 3 platform builds</li>\n<li>b5b0a74: feat(license-server): add /api/health diagnostic endpoint to debug Supabase connection</li>\n<li>daad01f: fix(license-server): enforce strict connection timeout on pg to prevent render 502 gateway timeouts</li>\n</ul>\n<!-- CHANGELOG_END -->\n"
  }
];
